...
newMain.innerHTML = `
  <main class="bg-[#000] px-[64px] pt-[80px] undefined pb-[80px]">
				...
				<div class="flex w-[684px] md:w-[684px] md:h-[188px] mt-[24px] lg:mt-0 lg:h-[248px] flex-wrap md:flex-nowrap gap-[40px]">
					...
					<div class="flex flex-col flex-1 min-w-0">
						...
						<div class="flex flex-col mt-[24px]"><a class="no-underline text-[14px] text-[#fff] whitespace-nowrap leading-[21px] font-[300] mb-[16px]" target="_blank" href="https://hailuoai.com/">海螺AI</a><a
								class="no-underline text-[14px] text-[#fff] whitespace-nowrap leading-[21px] font-[300] mb-[16px]" target="_blank" href="https://www.xingyeai.com/">星野</a><a class="no-underline text-[14px] text-[#fff] whitespace-nowrap leading-[21px] font-[300] mb-[16px]"
								target="_self" href="/platform.html">开放平台</a></div>
					</div>
					<div class="flex flex-col flex-1 min-w-0">
			...
			<section class="mx-auto max-w-[1312px]">
				...
				<div class="flex items-center flex-wrap justify-center"><a target="_blank" class="mt-2 flex items-center whitespace-nowrap no-underline text-[14px] font-[400] text-[#5C5F63] leading-[21px]" href="https://www.beian.gov.cn/portal/registerSystemInfo?recordcode=31010402010179"><img
							alt="沪公网安备" fetchpriority="high" width="14" height="14" decoding="async" data-nimg="1" class="mr-[4px]" style="color:transparent" src="static/picture/d3cb2fd4-f521-4944-88df-2789c20430ad.png"><span>沪公网安备 31010402010179号</span></a><a target="_blank"
						...
						href="https://www.minimaxi.com/license/broadcasting-business-license">广播电视节目制作经营许可证：（沪）字第05352号</a><a target="_blank" class="mt-2 ml-[16px] whitespace-nowrap no-underline text-[14px] font-[400] text-[#5C5F63] leading-[21px]"
						href="https://whlyj.sh.gov.cn/index.html">沪网文〔2023〕1566-110 号</a></div>
			</section>
		</main>
`;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // header.parentNode.insertBefore(newMain, header);

  // 如果想插入到某个特定元素的内部，例如 <main> 的开头：
  // const main = document.querySelector("main");
  // main.insertAdjacentElement("afterbegin", newMain);
});

...
// 设置一个标志位，初始为 false，表示还未检测到第 4 个元素
...
`;
newDiv.class = "w-full h-full mx-auto overflow-scroll relative pt-[0px] flex flex-col swiper-no-swiping pb-[120px] select-none"; // 设置 ID 或其他属性（可选）

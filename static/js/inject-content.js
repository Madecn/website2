	...
	<section class="mx-auto max-w-[1820px] pb-[80px] lg:flex md:justify-between md:h-[328px] text-[16px] leading-[24px] [border-bottom:1px_solid_#323232]">
		...
		<div class="flex w-[684px] md:w-[684px] md:h-[188px] mt-[24px] lg:mt-0 lg:h-[248px] flex-wrap md:flex-nowrap gap-[40px]">
			<div class="flex flex-col flex-1 min-w-0">
				...
				<div class="flex flex-col mt-[24px]"><a class="no-underline text-[14px] text-[#fff] whitespace-nowrap leading-[21px] font-[300] mb-[16px]" target="_self" href="https://minimaxi.com/news/minimax-01-%E7%B3%BB%E5%88%97">文本模型</a><a
						class="no-underline text-[14px] text-[#fff] whitespace-nowrap leading-[21px] font-[300] mb-[16px]" target="_self" href="https://minimaxi.com/news/t2a-01-hd-%E5%8F%91%E5%B8%83">语音模型</a><a class="no-underline text-[14px] text-[#fff] whitespace-nowrap leading-[21px] font-[300] mb-[16px]"
						target="_self" href="https://minimaxi.com/news/s2v-01%E5%8F%91%E5%B8%83">视频模型</a></div>
			</div>
			<div class="flex flex-col flex-1 min-w-0">
				<div class="text-[16px] text-[#fff] font-[500] leading-normal">最新更新</div>
				<div class="flex flex-col mt-[24px]"><a class="no-underline text-[14px] text-[#fff] whitespace-nowrap leading-[21px] font-[300] mb-[16px]" target="_self" href="https://minimaxi.com/news/minimax-01-%E7%B3%BB%E5%88%97">MiniMax-Text-01</a><a
						class="no-underline text-[14px] text-[#fff] whitespace-nowrap leading-[21px] font-[300] mb-[16px]" target="_self" href="https://minimaxi.com/news/s2v-01%E5%8F%91%E5%B8%83">S2V-01</a><a class="no-underline text-[14px] text-[#fff] whitespace-nowrap leading-[21px] font-[300] mb-[16px]"
						target="_self" href="https://minimaxi.com/news/t2a-01-hd-%E5%8F%91%E5%B8%83">T2A-01-HD</a></div>
			</div>
			<div class="flex flex-col flex-1 min-w-0">
			...
			<div class="flex flex-col flex-1 min-w-0">
				...
				<div class="flex flex-col mt-[24px]"><a class="no-underline text-[14px] text-[#fff] whitespace-nowrap leading-[21px] font-[300] mb-[16px]" target="_self" href="https://minimaxi.com/news">新闻动态</a><a class="no-underline text-[14px] text-[#fff] whitespace-nowrap leading-[21px] font-[300] mb-[16px]"
